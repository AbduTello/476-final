...
namespace DriveShare.API.Migrations
{
    ...
    [Migration("20250408081722_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DriveShare.API.Models.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("DriveShare.API.Models.CarListing", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("DriveShare.API.Models.CarListing", b =>
                {
                    b.HasOne("DriveShare.API.Models.ApplicationUser", "Owner")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("DriveShare.API.Models.ApplicationUser", null)
                        .WithMany()
